  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: "Cold Brew",
        description:
          "Smooth and strong coffee brewed slowly in cold water for a bold taste.",
        price: "$3.49",
      },
      {
...
export const menuItemsRight = [
  {
    ...
    items: [
      ...
      },
      {
        title: "Cinnamon Roll",
        description:
          "A sweet and gooey pastry swirled with cinnamon and icing.",
        price: "$3.99",
      },
      {
        title: "Danish Pastry",
        description:
          "A light and airy pastry filled with various sweet fillings.",
        price: "$4.49",
      },
      {
        title: "Scone",
...
export const articles = [
  {
    category: "Cafe",
    image: a1,
    description: "Exploring the Growing Trend and Art of Craft",
  },
  {
    category: "Topics",
    image: a2,
    description: "The Science Behind Your Daily Cup of Joy",
  },
  {
    category: "Business",
    image: a3,
    description: "A Journey Through Different Brewing Methods",
  },
];
