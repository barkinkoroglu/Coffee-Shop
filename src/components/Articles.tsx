    ...
    <div className="w-full lg:px-[310px] px-5 flex items-center justify-center mt-[50px]">
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="font-Source text-lg font-light text-secondary max-w-[500px] lg:text-left text-center">
          Discover the latest insights and updates in our blog. Stay informed
          with engaging articles and captivating stories from our expert
          writers.
        </p>
          ...
          {articles.map((article) => (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="font-Source text-[26px] text-secondary lg:text-left text-center hover:underline cursor-pointer ">
                  {article.description}
                </span>
              </div>
            </div>
