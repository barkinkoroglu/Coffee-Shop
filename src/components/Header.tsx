...
const Header = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-[-140px] left-1/2 transform -translate-x-1/2 w-full max-w-[90%] lg:max-w-[67.5vw] bg-white shadow-lg border border-gray-300 rounded-[20px] lg:h-[280px] flex items-center lg:justify-between justify-center lg:flex-row flex-col lg:px-14 p-7 gap-6 sm:gap-10">
        ...
        <div className="flex flex-col items-center lg:items-start lg:text-left text-center gap-2 border-gray-300 lg:pl-10">
          <span className="uppercase lg:pt-[80px] font-Bebas text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] text-gray-800 tracking-wide">
            It's Koffee Time!
          </span>
